...
CREATE TABLE "departments"(
	...
	CONSTRAINT "pk_departents" PRIMARY KEY(
		"dept_no"
	)
);
...
ALTER TABLE "dept_emp" ADD CONSTRAINT "fk_dept-emp_no" FOREIGN KEY("emp_no")
...
-- 5. List all employees gender and whose first name is "Hercules" and last names begin with "B."
